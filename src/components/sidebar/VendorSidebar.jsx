		...
		<div className="ec-left-sidebar ec-bg-sidebar">
			<div id="sidebar" className="sidebar ec-sidebar-footer">
				<div className="ec-brand">
					<Link to={'/vendors-dashboard'} title="SOS">
						<svg
							width="70"
							height="40"
							viewBox="0 0 100 65"
				...
				<div className="ec-navigation" data-simplebar>
					...
					<ul className="nav sidebar-inner" id="sidebar-menu">
						{/* <!-- Dashboard --> */}
						<li className="active">
							<NavLink to={'/vendors-dashboard'} className="sidenav-item-link">
								<svg
									width="20"
									height="20"
									viewBox="0 0 20 20"
						...
						>
							...
							<div style={{ display: nav2 && 'block' }} className="collapse">
								...
								>
									<li className="">
										<Link
											to={'/vendors-dashboard/product-add'}
						...
						<li className="has-sub">
							<NavLink to="/vendors-dashboard/orders-history" className="sidenav-item-link">
